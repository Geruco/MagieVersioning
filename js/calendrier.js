            ...
            for (var wk = 0; wk < weeksInMonth; wk++) {
                ...
                for (var dow = 0; dow < 7; dow++) {
                    if (dow < firstDow || currDayOfMonth > lastDayinMonth) {
                        ...
                        var day = "2019"+dayId.split("2019")[1];
                        day = day.split("_day")[0];
                        var idMag = document.location.href;
                        idMag = idMag.split("planning=")[1];
                        idMag = idMag.split("?")[0];
                        var $dayElement = $('<a href="../index.php?action=RDV&date='+day+'&idMag='+idMag+'" id="' + dayId + '" class="day" >' + currDayOfMonth + '</a>');
